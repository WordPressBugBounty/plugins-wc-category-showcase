...
namespace WooCommerceCategoryShowcase\ByteKit\Traits;
...
trait HasPlugin {
	...
	public function get_plugin_meta_links() {
		...
		if ( ! empty( $this->get_docs_url() ) ) {
			$links['docs'] = array(
				'label' => __( 'Documentation', 'wc-category-showcase' ),
		...
		if ( ! empty( $this->get_support_url() ) ) {
			$links['support'] = array(
				'label' => __( 'Support', 'wc-category-showcase' ),
		...
		if ( ! empty( $this->get_review_url() ) ) {
			$links['review'] = array(
				'label' => __( 'Review', 'wc-category-showcase' ),
	...
	public function get_plugin_action_links() {
		...
		if ( ! empty( $this->get_settings_url() ) ) {
			$links['settings'] = array(
				'label' => __( 'Settings', 'wc-category-showcase' ),
